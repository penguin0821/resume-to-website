// ReactBits - MagicRings (adapted for resume-to-site)
// WebGL concentric rings that expand outward with "quiet → burst → quiet" rhythm
...
export default function MagicRings({
  ...
  return (
    <div
      ref={mountRef}
      className={className}
      style={{ ...(blur > 0 ? { filter: `blur(${blur}px)` } : {}), ...style }}
    />
  );
}
